...

        {
          table: {
            ...
            body: [
              ...
              [
                { text: 'Instituto', style: 'tableHeader' },
                incident.institute.name,
              ],
              [
                { text: 'Tipo de Formulario', style: 'tableHeader' },
                incident.formType,
              ],
              ...
              [
                { text: 'Número de Cámara', style: 'tableHeader' },
                incident.cameraNumber,
              ],
              [
              ...
              [
                { text: 'Fecha de Atención', style: 'tableHeader' },
                incident.attentionDate,
              ],
              [
                { text: 'Fecha de Cierre', style: 'tableHeader' },
                incident.closingDate,
              ],
              [
                { text: 'Relevante', style: 'tableHeader' },
                incident.isRelevant ? 'Sí' : 'No',
              ],
